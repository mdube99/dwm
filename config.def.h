...
static       char font[]            = "Iosevka SS14 Medium:size=14:antialias=true:autohint=true";   /* Main font */
static       char fonticon[]        = "Symbols Nerd Font:size=12:antialias=true:autohint=true";     /* Icon Font */
...
static       char acc[]             = "#ef2929";    /* Accent */
static       char hgl[]             = "#cc241d";    /* Highlight */
...
/* Tagging */
static const char *tags[] = { "", "", "爵", "", "", "", "", "ﭾ", "" }; /* Requires Nerd Font */
static const char *tagsalt[] = { "𝟭", "𝟮", "𝟯", "𝗤", "𝗪", "𝗘", "𝗔", "𝗦", "𝗗" };
...
const char *spcmd0[] = {"tabbed", "-n", "spterm", "-c", "-g", "1080x660", "-r", "2", "st", "-w", "\'\'", "-t", "Scratchterm", NULL };
...
static const Rule rules[] = {
	...
	{ "Pinta",    	   NULL,     NULL,           1 << 5,    0,          0,          0,         -1 },
	{ "krita",    	   NULL,     NULL,           1 << 5,    0,          0,          0,         -1 },
	{ "Inkscape",      NULL,     NULL,           1 << 5,    0,          0,          0,         -1 },
	{ "Nwgbar",        NULL,     NULL,           0,         1,          0,          0,         -1 },
	{ "Nwggrid",       NULL,     NULL,           0,         1,          0,          0,         -1 },
...
static Key keys[] = {
	...
	// ## Scratchpad Toggles ##
   	// ========================
	{ MODKEY,                    XK_backslash, togglescratch,  {.ui = 0 } }, // term 
